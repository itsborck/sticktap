...
const HomePage = () => {
  return (
    <>
      <Navbar />
      <div className="container mx-auto my-8 text-center bg-gray-800 text-white">
        ...
        <Link
          to="/schedule"
          className="text-white bg-blue-500 py-2 px-4 rounded inline-block hover:bg-blue-600 transition duration-300"
        >
          Tap In!
        </Link>
      </div>
