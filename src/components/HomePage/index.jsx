    ...
    <Navbar />
      <div className="container mx-auto my-8 text-center dark:bg-gray-800 dark:text-white">
        ...
        <p className="text-lg mb-6">
          Explore the latest NHL games and stay up-to-date with live scores, schedules, and more.
        </p>
        <p className="text-md mb-6">
          StickTap brings you real-time information about your favorite hockey teams and matches.
          Discover detailed game statistics, team details, and enjoy listening to live radio broadcasts.
        </p>
        <Link
          to="/games"
