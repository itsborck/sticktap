...
const GameCalendar = ({ formattedDate, setFormattedDate }) => {
  ...
  return (
    <div className="flex justify-between text-white">
      <button onClick={previousDay} className="lg:ml-32 md:ml-16 sm:ml-8"><FaChevronLeft /></button>
      ...
      <button onClick={nextDay} className="lg:mr-32 md:mr-16 sm:mr-8"><FaChevronRight /></button>
    </div>
  );
};
