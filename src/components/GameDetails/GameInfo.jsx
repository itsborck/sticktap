  ...
  return (
    <div className="text-white bg-gray-800 p-4 rounded-lg shadow-md w-1/6">
      <div className="flex-col mt-2">
        ...
        {game.boxscore && game.boxscore.gameInfo && game.boxscore.gameInfo.homeTeam.headCoach.default && (
          <>
        ...
        {game.boxscore && game.boxscore.gameInfo && game.boxscore.gameInfo.awayTeam.headCoach.default && (
          <>
        ...
        {game.boxscore && game.boxscore.gameInfo && game.boxscore.gameInfo.referees.length > 0 && (
          <>
            <p>Referees</p>
        ...
        {game.boxscore && game.boxscore.gameInfo && game.boxscore.gameInfo.linesmen.length > 0 && (
          <>
            <p>Linesmen</p>
